...
class WikiEvalSampler(object):
    ...
    def __next__(self):
        ...
        if self.mode == 't,r->h':
            return F.tensor(self.edges['t,r->h']['tr'][beg:self.cnt], F.int64), F.tensor(self.edges['t,r->h']['h'][beg:self.cnt], F.int64), F.tensor(self.edges['t,r->h']['h_candidate'][beg:self.cnt], F.int64)
        elif self.mode == 'h,r->t':
            return F.tensor(self.edges['h,r->t']['hr'][beg:self.cnt], F.int64), F.tensor(self.edges['h,r->t']['t'][beg:self.cnt], F.int64), F.tensor(self.edges['h,r->t']['t_candidate'][beg:self.cnt], F.int64)
        # wikikg90m-v1
        # if self.mode == 't,r->h':
...
class EvalDataset(object):
    ...
    def __init__(self, dataset, args):
        ...
        elif self.name in ['wikikg90m-v2']:
