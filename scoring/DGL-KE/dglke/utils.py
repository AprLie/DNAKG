...
class CommonArgParser(argparse.ArgumentParser):
    def __init__(self):
        ...
        self.add_argument('--neg_sample_size_eval', type=int, default=19999,
        ...
        self.add_argument('--feat_hidden_dim', type=int, default=100,
                          help='The embedding size of relation and entity, LRE used only')